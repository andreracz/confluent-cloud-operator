...
# kubbee.tech/confluent-cloud-operator-bundle:$VERSION and kubbee.tech/confluent-cloud-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= kubbee.tech/confluent-cloud-operator
